    ...
    public IEnumerator SpaweningManager()
    {
        ...
        if (ManagerPose == false)
        {
            if (MakeIt == true)
            {
                ...
                /*else if (InGameManager.Instance?.CurrentReload == 1)
                {*/
                (Instantiate(ZombieLevel[1],
                    ...
                    as GameObject).transform.SetParent(SpawenLocalisation.transform);
                /*}
                else if (InGameManager.Instance?.CurrentReload == 2)
                {
                ...
                else if (InGameManager.Instance?.CurrentReload == 3)
                {
                ...
                else if (InGameManager.Instance?.CurrentReload == 4)
                {
