...
public class BoltSHooter : MonoBehaviour
{
    ...
    [Header("Pefabes Manager")] public GameObject Diamond;
    public GameObject DiamondPos;

    [Header("Boolean Manager")] internal bool EnemyDispo = true;
    internal bool SpawenHire = true;
    internal bool CheckingList = true;

    [Header("Floating Manager")] internal int SpawenPoint;
    ...
    void Update()
    {
        ...
        if (EnemyDispo == true)
        {
            ...
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.FindGameObjectWithTag("Enemy").transform.position, 10 * Time.deltaTime);
    ...
    void CheckPlaceSpawening()
    {
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos1").transform.position, 10f * Time.deltaTime);
            ...
            {
                (Instantiate(Diamond, transform.position, Diamond.transform.rotation) as GameObject).transform
                    .SetParent(DiamondPos.transform);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos2").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos3").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos4").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos5").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos6").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos7").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos8").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos9").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos10").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos11").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos12").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos13").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos14").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos15").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos16").transform.position, 10f * Time.deltaTime);
        ...
        {
            transform.position = Vector2.MoveTowards(this.transform.position,
                GameObject.Find("Pos17").transform.position, 10f * Time.deltaTime);
